...
#define read_byte(addr) m->read(m->ctx, addr); m->cycles += 1
...
#define pop(m) read_byte((++m->s) | 0x100);
#define branch_on(arg, cond) if(cond){ i16 ext_arg = (i16)(i8)arg; u16 new_pc = m->pc + ext_arg; read_byte(m->pc); if(new_pc >> 8 != m->pc >> 8){ read_byte((m->pc & 0xFF00) | (new_pc & 0xFF) ); } m->pc = new_pc; } 
...
static void JAM(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void SLO(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void ANC(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void ALR(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void ARR(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void SAX(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void ANE(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void TAS(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void SHY(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void SHX(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void LXA(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void LAS(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void SBX(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void USBC(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void ISC(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void DCP(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void RLA(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void SRE(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void RRA(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static void SHA(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
static void LAX(m6502_t* m) { printf("NOT IMPLEMENTED %s\n", __func__); }
...
static opcode_t opcode_table[256] = {
    {BRK, IMP_0, 0}, {ORA, X_IND, 0}, {JAM, IMP_0, 0}, {SLO, X_IND, 0},	{NOP, ZPG_0, 0}, {ORA, ZPG_0, 0}, {ASL, ZPG_0, 0}, {SLO, ZPG_0, 0},	{PHP, IMP_0, 0}, {ORA, IMM_0, 0}, {ASL, ACC_0, 0}, {ANC , IMM_0, 0}, {NOP, ABS_0, 0}, {ORA, ABS_0, 0}, {ASL, ABS_0, 0}, {SLO, ABS_0, 0},
    {BPL, REL_0, 0}, {ORA, IND_Y, 0}, {JAM, IMP_0, 0}, {SLO, IND_Y, 0},	{NOP, ZPG_X, 0}, {ORA, ZPG_X, 0}, {ASL, ZPG_X, 0}, {SLO, ZPG_X, 0},	{CLC, IMP_0, 0}, {ORA, ABS_Y, 0}, {NOP, IMP_0, 0}, {SLO , ABS_Y, 0}, {NOP, ABS_X, 0}, {ORA, ABS_X, 0}, {ASL, ABS_X, 1}, {SLO, ABS_X, 0},
    ...
    {BMI, REL_0, 0}, {AND, IND_Y, 0}, {JAM, IMP_0, 0}, {RLA, IND_Y, 0},	{NOP, ZPG_X, 0}, {AND, ZPG_X, 0}, {ROL, ZPG_X, 0}, {RLA, ZPG_X, 0},	{SEC, IMP_0, 0}, {AND, ABS_Y, 0}, {NOP, IMP_0, 0}, {RLA , ABS_Y, 0}, {NOP, ABS_X, 0}, {AND, ABS_X, 0}, {ROL, ABS_X, 1}, {RLA, ABS_X, 0},
    {RTI, IMP_0, 0}, {EOR, X_IND, 0}, {JAM, IMP_0, 0}, {SRE, X_IND, 0},	{NOP, ZPG_0, 0}, {EOR, ZPG_0, 0}, {LSR, ZPG_0, 0}, {SRE, ZPG_0, 0},	{PHA, IMP_0, 0}, {EOR, IMM_0, 0}, {LSR, ACC_0, 0}, {ALR , IMM_0, 0}, {JMP, ABS_0, 0}, {EOR, ABS_0, 0}, {LSR, ABS_0, 0}, {SRE, ABS_0, 0},
    {BVC, REL_0, 0}, {EOR, IND_Y, 0}, {JAM, IMP_0, 0}, {SRE, IND_Y, 0},	{NOP, ZPG_X, 0}, {EOR, ZPG_X, 0}, {LSR, ZPG_X, 0}, {SRE, ZPG_X, 0},	{CLI, IMP_0, 0}, {EOR, ABS_Y, 0}, {NOP, IMP_0, 0}, {SRE , ABS_Y, 0}, {NOP, ABS_X, 0}, {EOR, ABS_X, 0}, {LSR, ABS_X, 1}, {SRE, ABS_X, 0},
    {RTS, IMP_0, 0}, {ADC, X_IND, 0}, {JAM, IMP_0, 0}, {RRA, X_IND, 0},	{NOP, ZPG_0, 0}, {ADC, ZPG_0, 0}, {ROR, ZPG_0, 0}, {RRA, ZPG_0, 0},	{PLA, IMP_0, 0}, {ADC, IMM_0, 0}, {ROR, ACC_0, 0}, {ARR , IMM_0, 0}, {JMP, IND_0, 0}, {ADC, ABS_0, 0}, {ROR, ABS_0, 0}, {RRA, ABS_0, 0},
    {BVS, REL_0, 0}, {ADC, IND_Y, 0}, {JAM, IMP_0, 0}, {RRA, IND_Y, 0},	{NOP, ZPG_X, 0}, {ADC, ZPG_X, 0}, {ROR, ZPG_X, 0}, {RRA, ZPG_X, 0},	{SEI, IMP_0, 0}, {ADC, ABS_Y, 0}, {NOP, IMP_0, 0}, {RRA , ABS_Y, 0}, {NOP, ABS_X, 0}, {ADC, ABS_X, 0}, {ROR, ABS_X, 1}, {RRA, ABS_X, 0},
    {NOP, IMM_0, 0}, {STA, X_IND, 1}, {NOP, IMM_0, 0}, {SAX, X_IND, 0},	{STY, ZPG_0, 0}, {STA, ZPG_0, 1}, {STX, ZPG_0, 0}, {SAX, ZPG_0, 0},	{DEY, IMP_0, 0}, {NOP, IMM_0, 0}, {TXA, IMP_0, 0}, {ANE , IMM_0, 0}, {STY, ABS_0, 0}, {STA, ABS_0, 0}, {STX, ABS_0, 0}, {SAX, ABS_0, 0},
    {BCC, REL_0, 0}, {STA, IND_Y, 1}, {JAM, IMP_0, 0}, {SHA, IND_Y, 0},	{STY, ZPG_X, 0}, {STA, ZPG_X, 1}, {STX, ZPG_Y, 0}, {SAX, ZPG_Y, 0},	{TYA, IMP_0, 0}, {STA, ABS_Y, 1}, {TXS, IMP_0, 0}, {TAS , ABS_Y, 0}, {SHY, ABS_X, 0}, {STA, ABS_X, 1}, {SHX, ABS_Y, 0}, {SHA, ABS_Y, 0},
    ...
    {CPY, IMM_0, 0}, {CMP, X_IND, 0}, {NOP, IMM_0, 0}, {DCP, X_IND, 0},	{CPY, ZPG_0, 0}, {CMP, ZPG_0, 0}, {DEC, ZPG_0, 0}, {DCP, ZPG_0, 0},	{INY, IMP_0, 0}, {CMP, IMM_0, 0}, {DEX, IMP_0, 0}, {SBX , IMM_0, 0}, {CPY, ABS_0, 0}, {CMP, ABS_0, 0}, {DEC, ABS_0, 0}, {DCP, ABS_0, 0},
    {BNE, REL_0, 0}, {CMP, IND_Y, 0}, {JAM, IMP_0, 0}, {DCP, IND_Y, 0},	{NOP, ZPG_X, 0}, {CMP, ZPG_X, 0}, {DEC, ZPG_X, 0}, {DCP, ZPG_X, 0},	{CLD, IMP_0, 0}, {CMP, ABS_Y, 0}, {NOP, IMP_0, 0}, {DCP , ABS_Y, 0}, {NOP, ABS_X, 0}, {CMP, ABS_X, 0}, {DEC, ABS_X, 1}, {DCP, ABS_X, 0},
    {CPX, IMM_0, 0}, {SBC, X_IND, 0}, {NOP, IMM_0, 0}, {ISC, X_IND, 0},	{CPX, ZPG_0, 0}, {SBC, ZPG_0, 0}, {INC, ZPG_0, 0}, {ISC, ZPG_0, 0},	{INX, IMP_0, 0}, {SBC, IMM_0, 0}, {NOP, IMP_0, 0}, {USBC, IMM_0, 0}, {CPX, ABS_0, 0}, {SBC, ABS_0, 0}, {INC, ABS_0, 0}, {ISC, ABS_0, 0},
    {BEQ, REL_0, 0}, {SBC, IND_Y, 0}, {JAM, IMP_0, 0}, {ISC, IND_Y, 0},	{NOP, ZPG_X, 0}, {SBC, ZPG_X, 0}, {INC, ZPG_X, 0}, {ISC, ZPG_X, 0},	{SED, IMP_0, 0}, {SBC, ABS_Y, 0}, {NOP, IMP_0, 0}, {ISC , ABS_Y, 0}, {NOP, ABS_X, 0}, {SBC, ABS_X, 0}, {INC, ABS_X, 1}, {ISC, ABS_X, 0}
};
    ...
    switch (type){
        ...
        case ABS_X:
        {
            ...
            if(op_slow || (u8)m->mem_addr + m->x > 0xFF){
                ...
                read_byte((m->mem_addr & 0xFF00) | tmp_lo);
            }
            m->mem_addr += m->x;
        }
        break;
